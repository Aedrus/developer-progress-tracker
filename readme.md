...
|Futuristic Assistant/Chatbot AI for Windows | Software that allows you to open an AI chatbot that you can type to, ask questions, and interact with as a powerful assisstant. Utilized AI and any other technology such as cutting-edge  text-to-speech and sleek modern animations. Similar to Cortana but better and can be started with a key command much like the openlook app and then passed anything from "How far is the Moon from Earth?" to "Find great Thai restaurants near me".|                 
|Grammar app/plugin | An AI app/plugin that helps correct grammar in real time. The unqiue trait of this app could be sentence suggestions. This means the app gives basic recommendations but can also rewrite sentences giving users a practical idea of how to improve their writing, line by line. It doubles as a grammar/spellchecker and a handy learning app to help users improve in a meaningful way!|                 
